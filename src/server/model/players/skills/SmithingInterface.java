...
public class SmithingInterface {
	...
	private void makeRuneInterface(Client c) {
		...
		c.getPA().sendFrame126(GetForlvl(90, c) + "Scimitar" + GetForlvl(5, c),
				1087);
		c.getPA().sendFrame126(
				GetForlvl(90, c) + "Arrowtips" + GetForlvl(5, c), 1108);
		c.getPA().sendFrame126(GetForlvl(89, c) + "Sword" + GetForlvl(4, c),
				1085);
		c.getPA().sendFrame126(GetForlvl(89, c) + "Bolts" + GetForlvl(4, c),
				9144);
		c.getPA().sendFrame126(GetForlvl(89, c) + "Nails" + GetForlvl(4, c),
				13358);
		c.getPA().sendFrame126(
				GetForlvl(88, c) + "Medium Helm" + GetForlvl(3, c), 1102);
		c.getPA().sendFrame126(GetForlvl(87, c) + "Mace" + GetForlvl(2, c),
				1093);
		c.getPA().sendFrame126(GetForlvl(85, c) + "Dagger" + GetForlvl(1, c),
				1094);
		c.getPA()
	...
	private void makeAddyInterface(Client c) {
		...
		c.getPA().sendFrame126(GetForlvl(75, c) + "Scimitar" + GetForlvl(5, c),
				1087);
		c.getPA().sendFrame126(
				GetForlvl(75, c) + "Arrowtips" + GetForlvl(5, c), 1108);
		c.getPA().sendFrame126(GetForlvl(74, c) + "Sword" + GetForlvl(4, c),
				1085);
		c.getPA().sendFrame126(GetForlvl(74, c) + "Bolts" + GetForlvl(4, c),
				9143);
		c.getPA().sendFrame126(GetForlvl(74, c) + "Nails" + GetForlvl(4, c),
				13358);
		c.getPA().sendFrame126(
				GetForlvl(73, c) + "Medium Helm" + GetForlvl(3, c), 1102);
		c.getPA().sendFrame126(GetForlvl(72, c) + "Mace" + GetForlvl(2, c),
				1093);
		c.getPA().sendFrame126(GetForlvl(70, c) + "Dagger" + GetForlvl(1, c),
				1094);
		c.getPA()
	...
	private void makeMithInterface(Client c) {
		...
		c.getPA().sendFrame126(GetForlvl(55, c) + "Scimitar" + GetForlvl(5, c),
				1087);
		c.getPA().sendFrame126(
				GetForlvl(55, c) + "Arrowtips" + GetForlvl(5, c), 1108);
		c.getPA().sendFrame126(GetForlvl(54, c) + "Sword" + GetForlvl(4, c),
				1085);
		c.getPA().sendFrame126(GetForlvl(54, c) + "Bolts" + GetForlvl(4, c),
				9142);
		c.getPA().sendFrame126(GetForlvl(54, c) + "Nails" + GetForlvl(4, c),
				13358);
		c.getPA().sendFrame126(
				GetForlvl(53, c) + "Medium Helm" + GetForlvl(3, c), 1102);
		c.getPA().sendFrame126(GetForlvl(52, c) + "Mace" + GetForlvl(2, c),
				1093);
		c.getPA().sendFrame126(GetForlvl(50, c) + "Dagger" + GetForlvl(1, c),
				1094);
		c.getPA()
	...
	private void makeSteelInterface(Client c) {
		...
		c.getPA().sendFrame126(GetForlvl(35, c) + "Scimitar" + GetForlvl(5, c),
				1087);
		c.getPA().sendFrame126(
				GetForlvl(35, c) + "Arrowtips" + GetForlvl(5, c), 1108);
		c.getPA().sendFrame126(GetForlvl(34, c) + "Sword" + GetForlvl(4, c),
				1085);
		c.getPA().sendFrame126(GetForlvl(34, c) + "Bolts" + GetForlvl(4, c),
				9141);
		c.getPA().sendFrame126(GetForlvl(34, c) + "Nails" + GetForlvl(4, c),
				13358);
		c.getPA().sendFrame126(
				GetForlvl(33, c) + "Medium Helm" + GetForlvl(3, c), 1102);
		c.getPA().sendFrame126(GetForlvl(32, c) + "Mace" + GetForlvl(2, c),
				1093);
		c.getPA().sendFrame126(GetForlvl(30, c) + "Dagger" + GetForlvl(1, c),
				1094);
		c.getPA()
				.sendFrame126(GetForlvl(31, c) + "Axe" + GetForlvl(1, c), 1091);
		c.getPA().sendFrame126(
				GetForlvl(35, c) + "Cannon Ball" + GetForlvl(35, c), 1096);
		c.getPA().sendFrame126(GetForlvl(36, c) + "Studs" + GetForlvl(36, c),
				1134);
	...
	private void makeIronInterface(Client c) {
		...
		c.getPA().sendFrame126(GetForlvl(20, c) + "Scimitar" + GetForlvl(5, c),
				1087);
		c.getPA().sendFrame126(
				GetForlvl(20, c) + "Arrowtips" + GetForlvl(5, c), 1108);
		c.getPA().sendFrame126(GetForlvl(19, c) + "Sword" + GetForlvl(4, c),
				1085);
		c.getPA().sendFrame126(GetForlvl(19, c) + "Bolts" + GetForlvl(4, c),
				9140);
		c.getPA().sendFrame126(GetForlvl(19, c) + "Nails" + GetForlvl(4, c),
				13358);
		c.getPA().sendFrame126(
				GetForlvl(18, c) + "Medium Helm" + GetForlvl(3, c), 1102);
		c.getPA().sendFrame126(GetForlvl(17, c) + "Mace" + GetForlvl(2, c),
				1093);
		c.getPA().sendFrame126(GetForlvl(15, c) + "Dagger" + GetForlvl(1, c),
				1094);
		c.getPA()
	...
	private void makeBronzeInterface(Client c) {
		...
		c.getPA().sendFrame126(GetForlvl(9, c) + "Warhammer" + GetForlvl(9, c),
				1083);
		c.getPA().sendFrame126(
				GetForlvl(8, c) + "Square Shield" + GetForlvl(8, c), 1104);
		c.getPA().sendFrame126(GetForlvl(7, c) + "Full Helm" + GetForlvl(7, c),
				1103);
		c.getPA().sendFrame126(
				GetForlvl(7, c) + "Throwing Knives" + GetForlvl(7, c), 1106);
		c.getPA().sendFrame126(
				GetForlvl(6, c) + "Long Sword" + GetForlvl(6, c), 1086);
		c.getPA().sendFrame126(GetForlvl(5, c) + "Scimitar" + GetForlvl(5, c),
				1087);
		c.getPA().sendFrame126(GetForlvl(5, c) + "Arrowtips" + GetForlvl(5, c),
				1108);
		c.getPA().sendFrame126(GetForlvl(4, c) + "Sword" + GetForlvl(4, c),
				1085);
		c.getPA().sendFrame126(GetForlvl(4, c) + "Bolts" + GetForlvl(4, c),
				1107);
		c.getPA().sendFrame126(GetForlvl(4, c) + "Nails" + GetForlvl(4, c),
				13358);
		c.getPA().sendFrame126(
