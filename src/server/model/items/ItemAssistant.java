...
public class ItemAssistant {
	...
	**/
	...
	/**
	* Adds special attack bar to special attack weapons.
	* Removes special attack bar to weapons that do not have special attacks.
	**/
...
break;
				...
				if (wearID == 11694 || wearID == 11696 || wearID == 11698 || wearID == 11700) {
					c.sendMessage("Godswords will not be avaliable in 2007remake.");
					return false;
				}
