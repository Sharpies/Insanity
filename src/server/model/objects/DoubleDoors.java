...
public class DoubleDoors {
	...
	/**
	 * The {@link Logger} instance for the {@link DoubleDoors} class.
	 */
	private static Logger logger = Logger.getLogger(DoubleDoors.class.getName());
	...
	public void load() {
		...
		logger.info("Loadded "+doors.size()+ " Double doors in "+(System.currentTimeMillis() - start)+ " ms.");
	}
