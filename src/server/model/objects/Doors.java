...
public class Doors {
	...
	/**
	 * The {@link Logger} instance for the {@link Door} class.
	 */
	private static Logger logger = Logger.getLogger(Doors.class.getName());
	...
	public void load() {
		...
		logger.info("Loaded " +doors.size()+ " doors in " +(System.currentTimeMillis() - start)+ " ms.");
	}
